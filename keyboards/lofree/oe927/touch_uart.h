...
/**
 * \brief Deinitialize the UART driver. This function must be called only once, before any of the below functions can be called.
 *
 * \param baud The baud rate to transmit and receive at. This may depend on the device you are communicating with. Common values are 1200, 2400, 4800, 9600, 19200, 38400, 57600, and 115200.
 */
...
/**
 * \brief Return whether the receive buffer contains data. Call this function to determine if `touch_uart_read()` will return data immediately.
 *
